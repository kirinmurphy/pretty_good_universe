...
export const rawArtistList_full = [
  ...
  { 
    ...
    bio: "Chance was a very short lived São Paulo, Brazil based post-punk band, fusing dark, traditional (almost gothic) influences with modern analog electronic programming.  The band apparently released only two songs on the 1985 release \”Não São Paulo”\, a compilation of prominent underground local acts of the time.  Little is known about this act besides their contribution to this compilation.",
  ...
  { 
    ...
    bio: "Harmonia is a Krautrock supergroup from Germany. They formed as a collaboration between Michael Rother of Neu! and Hans-Joachim Roedelius and Dieter Moebius of Cluster and later included British ambient music artist Brian Eno.",
    bioLink: BIOLINK_DISCOGS,
  },
  { 
    name: "Roberto Musci",
  ...
  { 
    ...
    bio: "Atom™ (also known as Atom Heart, along with many, many other recording alaises, and often confused with Señor Coconut, real name Uwe Schmidt) is a German composer, musician and record producer of electronic music. He is often regarded as the father of electrolatino, electrogospel and aciton (acid-reggaeton) music.",
  ...
  },
  {
    ...
    bio: "Roger Webb (7 April 1934 in Bristol – 19 December 2002 in London) was a British songwriter and jazz pianist best known for leading Roger Webb's Trio (1963-1965) for television series and club performances, and Roger Webb's Orchestra.  His songs were sung by Bette Davis, Rex Harrison, Johnny Mathis, Shirley Bassey, Danny Williams and others.  In 1979 his song Flying Objects was infamously used for Amber Waves controversial documentary about early adult film star Dirk Diggler.",
    bioLink: BIOLINK_DISCOGS,
  },
  { 
    name: "Arthur Russell",
  ...
  },
  {
    ...
    tags: [
      tags.HIP_HOP_SAMPLE_SOURCE, tags.FEMME_FATALE
    ],
  ...
  {
    name: "Jacqueline Thibault (Laurence Vanay)",
    from: "France",
    youtubeClips: [
      { videoId: "JJ8SZDc0DeI" },
      { videoId: "k7lJ8kNwK_0" },
